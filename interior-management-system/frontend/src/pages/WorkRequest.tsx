                      ...
                      <div className="flex items-center justify-center space-x-2">
                        {request.status === 'pending' && (
                          <button
                            ...
                            className="px-3 py-1 text-xs font-semibold text-white rounded-lg transition-colors bg-gray-900 hover:bg-gray-800"
                          >
                            수락
                          </button>
                        )}
          ...
          {filteredRequests.map((request) => (
            ...
            <div className="flex gap-2 mt-3 pt-3 border-t border-gray-100">
              {request.status === 'pending' && (
                <button
                  onClick={() => handleStatusChange(request.id, 'in-progress')}
                  className="flex-1 px-3 py-2 text-xs font-semibold text-white rounded-lg transition-colors bg-gray-900 hover:bg-gray-800"
                >
                  수락
                </button>
              )}
