...
const backupDbPath = 'C:\\Users\\kim_s\\Desktop\\HV_LAB_BACKUP_2025-10-26_045145\\database.db';
const db = new sqlite3.Database(backupDbPath, sqlite3.OPEN_READONLY);

console.log('=== 백업 데이터베이스 정보 ===');
console.log('Path:', backupDbPath);
console.log('');
